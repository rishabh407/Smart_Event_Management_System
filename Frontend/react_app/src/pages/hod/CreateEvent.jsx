...
const CreateEvent = () => {
  ...
  // Keep "now" updated every minute so the start picker stays accurate
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <DateTimePicker
              ...
              minDateTime={nowISO}           // cannot pick anything before right now
              isStart={true}                 // shows "today" banner with current time info
              required
            ...
            <DateTimePicker
              ...
              minDateTime={formData.startDate || nowISO}  // cannot pick before start
          ...
          <div>
            ...
            {coordinatorsLoading ? (
              ...
              <>
                ...
                >
                  <option value="">
                    {coordinators.length === 0 ? "-- No Coordinators Available --" : "-- Select Coordinator --"}
                  </option>
                  {coordinators.map((coordinator) => (
                    <option key={coordinator._id} value={coordinator._id}>
                      {coordinator.fullName} {coordinator.email ? `(${coordinator.email})` : ""}
                ...
                {errors.coordinatorId && <p className="mt-1 text-sm text-red-600">{errors.coordinatorId}</p>}
              </>
            )}
          </div>
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Recommended size: 1200x400px. Max size: 5MB</p>
          </div>
