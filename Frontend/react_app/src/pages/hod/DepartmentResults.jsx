...
const DepartmentResults = () => {
  ...
  const filteredResults = resultsData.filter((item) =>
    ...
    item.competition.event?.title?.toLowerCase().includes(search.toLowerCase())
  );
    ...
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 text-sm sm:text-base mt-1">
          View results for all competitions in your department's events
        </p>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-10 text-center">
          ...
          {!search && (
            <p className="text-gray-400 text-sm">
              Results will appear here once they are declared for competitions in your events
            </p>
          )}
        </div>
      )}
                ...
                <div>
                  ...
                  {item.competition.event && (
                    <p className="text-sm text-gray-600 mt-1">
                      ...
                      {item.competition.event.coordinator && (
                        <span className="ml-2">
                          • Coordinator: {item.competition.event.coordinator.fullName}
                        </span>
                      )}
                    </p>
                  )}
