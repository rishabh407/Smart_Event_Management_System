...
export const generateCertificates = async (req, res) => {
  try {
    ...
    // Determine if this is a team competition
      ...
      if (isTeamCompetition) {
        ...
        for (const memberId of team.members) {
          ...
          const pdfPath = await generateCertificatePDF({
            ...
            templatePath,
            textConfig: textConfig || {},
            isTeam: true // ✅ NEW: Add this for team competitions
          });
        ...
        const pdfPath = await generateCertificatePDF({
          name: user.fullName,
          teamName: null, // ✅ No team name for individual
          competitionName: competition.name,
          position: isWinner ? winner.position : null,
          templatePath,
          textConfig: textConfig || {},
          isTeam: false // ✅ NEW: Add this for individual competitions
        });
